...
public class Crop extends Item {
	...
	private FertilizeAction fertilizeAction = new FertilizeAction(this);

	public Crop(String name) {
		super(name, 'c', false); // 3rd parameter is false because Crop is never portable.
		this.allowableActions.add(this.fertilizeAction);
	}
	...
	public void fertilizeCrop() {
		...
		if (this.age >= 20) { // crop can't be fertilized anymore after it's ripe
			this.allowableActions.remove(this.fertilizeAction);
		}
	}
}